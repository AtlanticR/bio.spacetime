...
vgs = bio.spacetime::spacetime.variogram( locs_xy, z, methods="gstat" )
vgr = bio.spacetime::spacetime.variogram( locs_xy, z, methods="geoR" )
vsp = bio.spacetime::spacetime.variogram( locs_xy, z, methods="spBayes" )
vrf = bio.spacetime::spacetime.variogram( locs_xy, z, methods="RandomFields" )
vin = bio.spacetime::spacetime.variogram( locs_xy, z, methods="inla" )
